...
# sample_special_awesome_skill
# By b-rad <brandon.diaz@rutgers.edu>
#
# An example Alexa skill that does nothing you can't find anywhere else
...
__author__ = 'b-rad'
__email__ = 'brandon.diaz@rutgers.edu'
...
def handle_launch():
    ...
    * Card title: 'sample_special_awesome_skill
    * Card body: 'welcome_card'
    ...
    return question("Welcome to super special awesomeness.").reprompt("This is super special awesomeness. How may I assit you?").standard_card(title="sample_special_awesome_skill",
                                                                          text="This was the welcome card text")
...
def handle_cancel():
    ...
    return statement("The action has been halted!")
